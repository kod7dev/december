...
<head>
    ...
    <title>Kayıt - <?php echo TITLE; ?></title>
...
<body class="bg-primary">
                                ...
                                <div class="card-body">
                                    <form method="post" action="/controllers/register.php">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" name="password_" id="inputPasswordConfirm" type="password" placeholder="Confirm password" />
                                                    <label for="inputPasswordConfirm">Şifre Onayla</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><button type="submit" class="btn btn-primary btn-block">Hesap Oluştur</button></div>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="/login.php">Hesabınız var mı? Giriş yapın.</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="/assets/css/styles.cssjs/scripts.js"></script>
</body>
